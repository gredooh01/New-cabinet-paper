        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.cabinetPaper.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.cabinet-papers.update", [$cabinetPaper->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('cabinet_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="cabinet_type" id="cabinet_type" required>
                                ...
                                @foreach(App\Models\CabinetPaper::CABINET_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('cabinet_type', $cabinetPaper->cabinet_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('cabinet_num') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="cabinet_num" id="cabinet_num" value="{{ old('cabinet_num', $cabinetPaper->cabinet_num) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('issue_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="issue_date" id="issue_date" value="{{ old('issue_date', $cabinetPaper->issue_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('dispatch_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="dispatch_date" id="dispatch_date" value="{{ old('dispatch_date', $cabinetPaper->dispatch_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('archive_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="archive_date" id="archive_date" value="{{ old('archive_date', $cabinetPaper->archive_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('cabinet_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="cabinet_title" id="cabinet_title" value="{{ old('cabinet_title', $cabinetPaper->cabinet_title) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('cabinet_ministry') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="cabinet_ministry" id="cabinet_ministry" value="{{ old('cabinet_ministry', $cabinetPaper->cabinet_ministry) }}" required>
